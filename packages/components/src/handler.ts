        ...
        for (const provider in analytic) {
            ...
            if (providerStatus) {
                ...
                if (provider === 'langSmith') {
                    ...
                    console.log(`LangFuse SecretKey: ${langFuseSecretKey}`);
                    console.log(`LangFuse PublicKey: ${langFusePublicKey}`);
                    ...
                    console.log("LangFuse Options:", langFuseOptions);

                    const handler = new CallbackHandler(langFuseOptions as any);
